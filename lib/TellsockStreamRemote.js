/* Stream interface to a remote tellstick
*/
...
function TellstickStreamRemote(host) {
    this.buf = []
    this.setup(host)
    Duplex.call(this, { objectMode: true })
}
util.inherits(TellstickStreamRemote, Duplex)

TellstickStreamRemote.prototype.setup = function (host) {
...
TellstickStreamRemote.prototype._read = function (size) {
...
TellstickStreamRemote.prototype._write = function (arr, enc, done) {
    if (this.remote) {
...
TellstickStreamRemote.prototype.initRemote = function(host) {
...
module.exports = TellstickStreamRemote
